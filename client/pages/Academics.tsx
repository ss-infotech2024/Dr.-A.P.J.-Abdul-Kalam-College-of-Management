            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-gray-200 hover:bg-blue-50 transition">
                  ...
                  <td className="px-6 py-4 font-semibold text-primary">MBA</td>
            ...
            {["2024-2025", "2025-2026", "2026-2027"].map((year) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition inline-flex items-center justify-center gap-2"
                >
                  <Download size={20} />
                  View PDF
                </button>
            ...
            {admissionRules.map((rule, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-4 flex items-start gap-4 hover:bg-blue-50 transition"
                >
                  <span className="bg-primary text-white w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0 mt-1">
                    {index + 1}
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg mb-8">
            <p className="text-red-800 font-semibold">
              ⚠️ All students are required to follow these regulations strictly.
            ...
            {regulations.map((regulation, index) => (
              ...
              >
                <div className="flex gap-4">
                  <span className="bg-primary text-white w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0 text-sm">
                    {index + 1}
                  </span>
