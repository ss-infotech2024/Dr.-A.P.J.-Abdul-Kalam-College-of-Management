              ...
              <ul className="space-y-3">
                <li className="flex gap-3">
                  ...
                  <span className="text-gray-700">
                    On-line journals for research
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">✓</span>
                  <span className="text-gray-700">
                    E-Books collection accessible 24/7
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">✓</span>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 border-l-4 border-primary">
              <h3 className="text-xl font-bold text-primary mb-6">
                Book Issuing Guidelines
              </h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex gap-3">
                  <span className="font-bold">1.</span>
                  <span>
                    All students provided with required number of books for the
                    session
                  </span>
                </li>
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Check books for damage upon receipt; report immediately if
                    found
                  </span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span>
                    Lost books: Student must return new copy or pay equivalent
                    amount
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-green-50 rounded-lg shadow-lg p-8 border-l-4 border-secondary">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex gap-3">
                  ...
                  <span>
                    Extra-Curricular books in Hindi, Marathi & English
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="font-bold">•</span>
                ...
                <li className="flex gap-3">
                  <span className="font-bold">•</span>
                  <span>
                    On demand soft copy of Syllabus & Question Papers via email
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="font-bold">•</span>
